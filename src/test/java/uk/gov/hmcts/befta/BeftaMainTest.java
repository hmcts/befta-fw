...
class BeftaMainTest {
    ...
    /**
	 * Test method for {@link uk.gov.hmcts.befta.BeftaMain#main(java.lang.String[])}.
	 */
	@Test
	...
	/**
	 * Test method for {@link uk.gov.hmcts.befta.BeftaMain#main(java.lang.String[], uk.gov.hmcts.befta.TestAutomationConfig)}.
	 */
	@Test
    @SetEnvironmentVariable(key = DEFINITION_STORE_HOST_KEY, value = DEFINITION_STORE_HOST_VALUE)
    @SetEnvironmentVariable(key = IDAM_URL_KEY, value = IDAM_URL_VALUE)
	...
	/**
	 * Test method for {@link uk.gov.hmcts.befta.BeftaMain#main(java.lang.String[], uk.gov.hmcts.befta.TestAutomationAdapter)}.
	 */
	@Test
    @SetEnvironmentVariable(key = DEFINITION_STORE_HOST_KEY, value = DEFINITION_STORE_HOST_VALUE)
    @SetEnvironmentVariable(key = IDAM_URL_KEY, value = IDAM_URL_VALUE)
	...
	/**
	 * Test method for {@link uk.gov.hmcts.befta.BeftaMain#main(java.lang.String[], uk.gov.hmcts.befta.TestAutomationConfig, uk.gov.hmcts.befta.TestAutomationAdapter)}.
	 */
	@Test
    @SetEnvironmentVariable(key = DEFINITION_STORE_HOST_KEY, value = DEFINITION_STORE_HOST_VALUE)
    @SetEnvironmentVariable(key = IDAM_URL_KEY, value = IDAM_URL_VALUE)
	...
	/**
	 * Test method for {@link uk.gov.hmcts.befta.BeftaMain#runCucumberMain(java.lang.String[])}.
	 */
	@Test
    @SetEnvironmentVariable(key = DEFINITION_STORE_HOST_KEY, value = DEFINITION_STORE_HOST_VALUE)
    @SetEnvironmentVariable(key = IDAM_URL_KEY, value = IDAM_URL_VALUE)
