...
public interface BackEndFunctionalTestAutomationDSL {
    ...
    void performAndVerifyTheExpectedResponseForAnApiCallWithTimeout(String testDataSpec, String testDataId, String waitTime, String source) throws IOException;
